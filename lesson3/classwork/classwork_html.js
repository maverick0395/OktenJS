...
document.write('<div class="simpsons_wrapper">');
for (const person of simpsons) {
    document.write('<div class="simpsons">');
    document.write(`${person.name} ${person.surname} </br> ${person.age} </br> ${person.info} </br> <img src="${person.photo}" alt="${person.name} ${person.surname}">`);
    document.write('</div>');
}
document.write('</div>');
...
for (const person of simpsons) {
    document.write('<div class="simpsons">');
    document.write(`<h2>${person.name} ${person.surname}. Age is ${person.age}</h2>`);
    document.write(`<p>${person.info}</p>`);
    document.write(`<img src="${person.photo}" alt="${person.name} ${person.surname}">`);
    document.write('</div>');
}
document.write('</div>');
